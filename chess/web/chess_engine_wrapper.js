...
class ChessEngineWASM {
    ...
    setupFunctionWrappers() {
        ...
        // Position management
        this.chess_set_position = Module.cwrap('chess_set_position', 'number', ['string']);
        this.chess_get_fen = Module.cwrap('chess_get_fen', 'string', []);
        
        // Move operations
        this.chess_get_best_move = Module.cwrap('chess_get_best_move', 'string', ['number']);
        this.chess_make_move = Module.cwrap('chess_make_move', 'number', ['string']);
        this.chess_undo_move = Module.cwrap('chess_undo_move', 'number', []);
        this.chess_get_legal_moves = Module.cwrap('chess_get_legal_moves', 'string', []);
        ...
        this.chess_evaluate_position = Module.cwrap('chess_evaluate_position', 'number', []);
    }
